...
import cn.qssq666.giftanim.ui.StrokeTextView;
import cn.qssq666.giftanim.util.CountList;
import cn.qssq666.giftanim.util.DensityUtil;
...
//        android:animateLayoutChanges="true"
     ...
     * @param giftModel
     */
    public void showSingInstanceNewGift(final Context context, GiftModel giftModel) {
...
//                animation.set
    ...
    public void showNewGift(final Context context, UserInfoI userInfo, final GiftModel giftModel) {
    ...
    private void continueShow(Context context, UserInfoI userInfo, GiftModel giftModel, View view) {
...
//            sortMap.remove(getKey(userInfo,giftModel));
     ...
     */
    @Deprecated
    public void productAndShow(final Context context, final UserInfoI userInfo, final GiftModel giftModel) {

        final ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.view_live_gift_bar, this, false);
        ...
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        LinearLayout.LayoutParams layoutParams = (LayoutParams) viewGroup.getLayoutParams();
...
//                animation.set
    ...
    public static String getKey(UserInfoI userInfo, GiftModel giftModel) {
...
//        final Animation animation = AnimationUtils.loadAnimation(context, R.anim.follow_anim_from_left_vertical_centerr);
                                     ...
                                     public void run() {
                                         ...
                                         synchronized (GiftAnimLayout.class) {
                                             if (waitList.size() > 0 && getChildCount() <= maxShowCount) {//如果有最大限制的总数了就不应该超过。
                                                 ...
                                                 final GiftModel giftModel = userInfoGiftModelPair.second;
                                                 Log.i(TAG, "总数：" + count);
    ...
    class LoopRunnable implements Runnable {
        ...
        public void run() {
            ...
            GiftModel giftModel = userInfoGiftModelPair.second;
            if (count > 0) {
